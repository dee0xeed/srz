...
pub const BitPredictor = struct {
    ...
    pub fn init(a: Allocator) !BitPredictor {
        var bp = BitPredictor{};
        //bp.p0 = try a.alloc(u16, @as(u32, 1) << 24);
        bp.p0 = try a.alloc(u16, @as(u32, 1) << 25);
    ...
    pub inline fn setContext(self: *BitPredictor, cx: u32) void {
        self.cx = cx;
    }
};
